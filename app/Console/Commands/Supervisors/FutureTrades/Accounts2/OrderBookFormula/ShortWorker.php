...
use App\Services\OrderBookFormula\OrderBookFormulaShort;
...
class ShortWorker extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:acc-2-order-book-short-worker';
    ...
    public function handle()
    {
        while (true) {
            try {
                OrderBookFormulaShort::performLiveTrades('FUTURE', 2);
            } catch (\Exception $th) {
