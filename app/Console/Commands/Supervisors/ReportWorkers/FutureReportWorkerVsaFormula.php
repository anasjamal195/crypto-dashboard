...
use App\Services\ReportServiceVsaFormula\LongReportService;
use App\Services\ReportServiceVsaFormula\ShortReportService;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Log;

class FutureReportWorkerVsaFormula extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:future-report-worker-vsa-formula';
    public $interval;
    public $limit;
    public $rsiThreshold;
    public $obvCandles;
