...
use App\Services\ReportServiceRsiBreakoutFormula\LongReportService;
use App\Services\ReportServiceRsiBreakoutFormula\ShortReportService;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Log;

class FutureReportWorkerRsiBreakoutFormula extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:future-report-worker-rsi-breakout-formula';
    public $interval;
    public $limit;
    public $rsiThreshold;
    public $obvCandles;
