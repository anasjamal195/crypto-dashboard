...
class LiveTradeLONGFutureService
{
    /**
        ...
        foreach ($tradeHandler as $tradeInstance)
            try {
                ...
                if (isset($open_order['is_open']) && $open_order['is_open']) {
                    ...
                    $candleData15m = BinanceApiService::getCandleStickData($symbol, '5m', 1000, null, $market);
        ...
        if ($current_price > $tradeInstance->priceLock) {
            ...
            while ($isLoop) {
                ...
                if ($lowestPrice > $latestPrice) {
                    ...
                    BinanceApiService::openMarketPositionLiveTrader($tradeInstance->symbol,$tradeInstance->buy_price,$tradeInstance->side,$tradeInstance->leverage,$tradeInstance->tradeAcc);
                    $isLoop = false;
                }
                usleep(100000);
            }
