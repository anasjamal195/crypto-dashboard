    ...
    <div class="container-fluid">
        <div class="navbar-wrapper">
            ...
            @if (auth()->user()->role === 'analyst')
                <a class="navbar-brand mx-0 mt-2 font-bold" href="{{ route('home') }}">eGeniusCare Crypto Tools <br>(BETA)</a>
            @endif
            @if (auth()->user()->role !== 'analyst')
                <a class="navbar-brand"
                    href="{{ route('home') }}">{{ \App\CommonHelpers::getMetaValue(auth()->user()->id, 'enable_spot', 0) == 1 ? 'Spot Mode' : 'Future Mode' }}</a>
            @endif
