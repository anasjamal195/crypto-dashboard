    ...
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            ...
            @if (auth()->user()->role !== 'analyst')
                ...
                <li class="{{ request()->is('15m-candlesticks/*') ? 'active' : '' }}">
                    <a data-toggle="collapse" href="#candlesticksMenu" aria-expanded="true">
                        <i class="tim-icons icon-bank"></i>
                        <p>{{ __('15m-CandleSticks') }}
                            <b class="caret"></b>
                        </p>
                    </a>
                                ...
                                <div class="collapse" id="spotMenu">
                                    <ul class="nav">
                                        ...
                                        <li @if ($pageSlug == 'liveTradeResultsSPOT') class="active" @endif>
                                            <a href="{{ route('live.trades.result', 'SPOT') . '?interval=15m' }}">
                                                <i class="tim-icons icon-bell-55"></i>
                                                <p>{{ __('Live Trades') }}</p>
                                            </a>
                                        </li>
                            ...
                            <li
                                ...
                                <div class="collapse" id="futureMenu">
                                    <ul class="nav">
                                        ...
                                        <a href="{{ route('candle.averages', 'FUTURE') . '?interval=15m' }}">
                                            <i class="tim-icons icon-bell-55"></i>
                                            <p>{{ __('Ideal Indicators') }}</p>
                                        </a>
                                    </li> --}}
                                        ...
                                        <li @if ($pageSlug == 'liveTradeResultsFUTURE') class="active" @endif>
                                            <a href="{{ route('live.trades.result', 'FUTURE') . '?interval=15m' }}">
                                                <i class="tim-icons icon-bell-55"></i>
                                                <p>{{ __('Live Trades') }}</p>
                                            </a>
                                        </li>
