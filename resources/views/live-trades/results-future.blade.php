    ...
    <div class="container">
        ...
        @if (request()->get('start_date') || request()->get('end_date'))
            <div class="alert alert-info">
                @if (request()->get('start_date') && request()->get('end_date'))
                    Showing results from {{ \Carbon\Carbon::parse(request()->get('start_date'))->format('H:i A M d, Y ') }}
                    to
            ...
            <tbody>
                @foreach ($orders as $order)
                    @php
                        ...
                        if (isset($orderClose)) {
                            $orderCloseTime = Carbon::createFromFormat(
                                'Y-m-d H:i:s',
                                $orderClose->created_at,
                                'Asia/Karachi',
                            );
                    ...
                    <tr>
                        ...
                        <td>{{ $order->stopLoss ? App\CommonHelpers::getPercentDiff($order->price, $order->stopLoss) . '%' : '-' }}
                        </td>
                        ...
                        <td>
                            ...
                            @else
                                @php
                                    ...
                                    $dateClose = Carbon::createFromFormat(
                                        'Y-m-d H:i:s',
                                        $sqlTimestampClose,
                                        'Asia/Karachi',
                                    );
