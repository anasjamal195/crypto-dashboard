    ...
    <div class="container py-4">
        ...
        <form method="GET" action="{{ url()->current() }}">
            <div class="row my-4 px-2">
                <div class="col-md-4">
                    <input type="text" name="symbol" class="form-control" value="{{ request('symbol') }}"
                        placeholder="Enter Symbol">
                </div>
                <div class="col-md-4">
                    <input type="depth" step="any" name="depth" class="form-control" value="{{ request('depth') }}"
                        placeholder="Enter Depth">
                </div>
                <div class="col-md-4">
                    <button type="submit" class="btn btn-primary my-0">Apply</button>
                </div>
                </td>
            </div>
        </form>
        <div class="card shadow">
            <div class="card-header  d-flex justify-content-between align-items-center">
                <h2 class="mb-0 text-white">Order Book Snapshot Status</h2>
                        ...
                        <div class="card border-info">
                            ...
                            <div class="card-body">
                                <p class="">Please enter the Symbol and Depth to view details. These values are
                                    required to load the snapshot information and generate the candlestick chart.</p>
                            </div>
                        </div>
                    </div>
                </div>
