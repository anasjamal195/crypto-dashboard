                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="showTimeline" id="showTimeline" class="form-control select2">
                                                ...
                                                <option value="show"
                                                    {{ request('showTimeline') == 'show' ? 'selected' : '' }}>Shown
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="showSkippedTradesChart" id="showSkippedTradesChart"
                                                ...
                                                <option value="">Hidden</option>
                                                <option value="show"
                                                    {{ request('showSkippedTradesChart') == 'show' ? 'selected' : '' }}>
                                                    Shown
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="reportSummary" id="reportSummary" class="form-control select2">
                                                <option value="">Hidden</option>
                                                <option value="show"
                                                    {{ request('reportSummary') == 'show' ? 'selected' : '' }}>Shown
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="profitableTradesSummary" id="profitableTradesSummary"
                                                ...
                                                <option value="">Hidden</option>
                                                <option value="show"
                                                    {{ request('profitableTradesSummary') == 'show' ? 'selected' : '' }}>
                                                    Shown
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="profitableTradesCandleMovementSummary">Profitable Trades Candle
                                                Movement
                                                Summary</label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="lossTradesCandleMovementSummary">Loss Trades Candle Movement
                                                Summary</label>
                                            <select name="lossTradesCandleMovementSummary"
                                                id="lossTradesCandleMovementSummary" class="form-control select2">
                                                <option value="">Hidden</option>
                                                <option value="show"
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="showSymbolPerformanceMetrics">Show Symbol Performance
                                                Metrics</label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="position" id="position" class="form-control select2">
                                                ...
                                                <option value="LONG"
                                                    {{ request('position') == 'LONG' ? 'selected' : '' }}>
                                                    LONG</option>
                                                <option value="SHORT"
                                                    {{ request('position') == 'SHORT' ? 'selected' : '' }}>
                                                    SHORT</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="safe_mode_view" id="safe_mode_view"
                                                class="form-control select2">
                                        ...
                                        <div class="col-md-8 d-flex align-items-end justify-content-end">
                                            <div class="form-group d-flex gap-2">
                                                <button type="submit"
                                                    class="btn btn-primary btn-round mr-2">Apply</button>
                                        ...
                                        <div class="">
                                            <table class="table table-bordered table-stats">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="font-weight-bold">Max SL %</td>
                                                        <td>{{ round($maxSL, 2) }} %</td>
                                                        <td>Maximum SL percentage</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-weight-bold">Min SL %</td>
                                                        <td>{{ round($minSL, 2) }} %</td>
                                                        <td>Minimum SL Percentage</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-weight-bold">Avg SL %</td>
                                                        <td>{{ round($avgSL, 2) }} %</td>
                                                        <td>Average SL percentage</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-weight-bold">Trades above 5% SL</td>
                                                        <td>{{ round($tradesAbove5perSL, 2) }}</td>
                                                        <td>Trades that have more than 5% initial SL</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-weight-bold">Max LP %</td>
                                                        <td>{{ round($maxLP, 2) }} %</td>
                                                        <td>Maximum LP percentage</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-weight-bold">Min LP %</td>
                                                        <td>{{ round($minLP, 2) }} %</td>
                                                        <td>Minimum LP Percentage</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-weight-bold">Avg LP %</td>
                                                        <td>{{ round($avgLP, 2) }} %</td>
                                                        <td>Average LP percentage</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="3" class="font-weight-bold text-center">SR Stats
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>From {{ $totalTradesMACD }} total trades after fee deduction
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-weight-bold">Formula Accuracy</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Trades having rsi above {{ $rsiLimit }} and profitable
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="3" class="font-weight-bold text-center">RSI Below
                                                            and
                                                            equal {{ $rsiLimit }}</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>Trades having rsi Below {{ $rsiLimit }} and profitable
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-weight-bold">Loss</td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="coin-tags">
                                                                        ...
                                                                        @if ($coinDetails->is_metaverse)
                                                                            <span
                                                                                class="badge bg-info me-1">Metaverse</span>
                                                                        @endif
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        ...
                                        <p class="card-category">Reference Interval: {{ $trendReferenceIntervalActual }}
                                        </p>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="card-category ">{{ $reportAnalysis['profitable_trades'] }} profitable
                                        </p>
                                        <!-- Export Button -->
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($tradeArr as $trade)
                                                        @php
                                                            ...
                                                            $previousCandle = json_decode(
                                                                $trade['previousCandle'],
                                                                true,
                                                            );
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="card-category">Comparison of volume indicators between profitable and
                                            losing
                                            trades</p>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="card-category">Comparison of price indicators between profitable and
                                            losing
                                            trades</p>
                                    </div>
                                    <div class="card-body">
