                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(strtolower($trade->type) == 'buy')
                                                    <span class="badge badge-success">{{ ucfirst($trade->type) }}</span>
                                                @elseif(strtolower($trade->type) == 'sell')
                                                    <span class="badge badge-danger">{{ ucfirst($trade->type) }}</span>
                                                @else
                                                    <span class="badge badge-warning">{{ ucfirst($trade->type) }}</span>
                                                @endif
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center text-muted py-4">
                                                <i class="tim-icons icon-chart-bar-32 text-primary" style="font-size: 3rem;"></i>
